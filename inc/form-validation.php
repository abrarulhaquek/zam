...
if($_SESSION['captcha_img_string']['acf279f20a144a6a4f5472046e79346fe1028ec2'] != $_POST['captcha_input']){
	$captcha_element_id = 'cfgen-element-4-7'; // will be used in merge_post
	$captcha_elementlabel_id = 'cfgen-element-4-7-label'; // will be used in element_ids_values
	$json_error_array['cfgen-element-4-7']['errormessage'] = $contactform_obj->cfg['form_errormessage_captcha'];
	$error_captcha = true;
}
